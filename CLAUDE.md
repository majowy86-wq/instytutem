...
1. **Zmierz najpierw, buduj potem.** Otwórz element na żywej archon.au i pobierz `getBoundingClientRect()` + `getComputedStyle()` dla niego i jego rodzica/rodzeństwa. Nie zgaduj wartości z samego wyglądu.
