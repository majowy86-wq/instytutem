...
- [ ] **Strona zabiegu (depilacja laserowa) — 2 sekcje z tymczasową treścią wymyśloną w stylu, do podmiany na realną z instytutem.pl** (Runda 87, świadomie zaakceptowane przez użytkownika jako tymczasowe): (1) „Postępowanie zabiegowe" (zakładki Przygotowanie/Przebieg zabiegu/Pielęgnacja po zabiegu) — realna treść jest na instytutem.pl, ale nie udało się jej pobrać (akordeon POKAŻ/UKRYJ nie reagował na żadną formę kliknięcia/klawisza w tej rundzie — do zbadania osobno, może się udać przy innym podejściu/narzędziu); (2) „Przeciwwskazania" — lista wymyślona, wymaga realnej listy z instytutem.pl. Obie nadal oznaczone w kodzie `.todo-content`/„DO UZUPEŁNIENIA". **Cennik już uzupełniony realnymi danymi** (Runda 25-26/2026-09-01): 3 karty S/M/L (`.treatment-cards`, styl 1:1 z archon.au) z realnymi cenami i czasami trwania z Fresha (179/349/698 zł) — przy każdej przyszłej weryfikacji cen pamiętać, żeby brać je z Fresha, nie z instytutem.pl ani nie zgadywać (ustalone wprost przez użytkownika: Fresha jest zawsze aktualna).
- [ ] **Zdjęcia kart S/M/L w sekcji Cennik są tymczasowo pobrane wprost z archon.au** (`assets/images/treatments/epilacja-laserowa-block-{s,m,l}.jpg`, Runda 26/2026-09-01, na wyraźną prośbę użytkownika „na razie wstaw zdjęcia z archon.au") — do podmiany później na zdjęcia AI (Nano Banana/Gemini, zgodnie z ustalonym procesem) lub inne docelowe zdjęcia; użytkownik świadomie odroczył tę decyzję.
