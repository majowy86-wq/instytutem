...
| Strona zabiegu (szablon) — Depilacja Laserowa | ✅ pierwsza realna podstrona | 🟡 częściowo TODO | `/zabiegi/depilacja-laserowa-plock-lightsheer/index.html` — pierwsza realna podstrona usługi, domyślny szablon dla ~23 pozostałych. Styl 1:1 z archon.au (hero pełnoekranowy, sticky zakładki, akordeon FAQ-style, lista „dlaczego warto”, promo-banner, cennik). Treść real z instytutem.pl gdzie było dostępne (Efekty/Technologia w całości, hero/intro/quick-facts); Cennik uzupełniony w całości realnymi danymi z Fresha + pakietów z instytutem.pl (Runda 63/2026-09-02, patrz DOKUMENTACJA.md). Pozostają 2 sekcje (Postępowanie zabiegowe, Przeciwwskazania) z tymczasową treścią wymyśloną w stylu, jawnie oznaczoną `.todo-content`/„DO UZUPEŁNIENIA” — patrz TODO niżej i DOKUMENTACJA.md Runda 87. |
...
- [ ] **Strona zabiegu (depilacja laserowa) — 2 sekcje z tymczasową treścią wymyśloną w stylu, do podmiany na realną z instytutem.pl** (Runda 87, świadomie zaakceptowane przez użytkownika jako tymczasowe): (1) „Postępowanie zabiegowe" (zakładki Przygotowanie/Przebieg zabiegu/Pielęgnacja po zabiegu) — realna treść jest na instytutem.pl, ale nie udało się jej pobrać (akordeon POKAŻ/UKRYJ nie reagował na żadną formę kliknięcia/klawisza w tej rundzie — do zbadania osobno, może się udać przy innym podejściu/narzędziu); (2) „Przeciwwskazania" — lista wymyślona, wymaga realnej listy z instytutem.pl. Obie nadal oznaczone w kodzie `.todo-content`/„DO UZUPEŁNIENIA". **Cennik uzupełniony w całości realnymi danymi** (Runda 25-26/2026-09-01 dla kart S/M/L; Runda 63/2026-09-02 dla pełnej listy cen wg partii ciała + sekcji pakietów): 3 karty S/M/L (`.treatment-cards`) z cenami i czasami z Fresha (179/349/698 zł), akordeon `#cennik` z pełnym cennikiem partii ciała pogrupowanym wg strefy S/M/L (`.price-list`), sekcja pakietów (`.price-packages`) z realnymi danymi z instytutem.pl/pakiety (mini 6/comfort 10/premium 20) — przy każdej przyszłej weryfikacji cen pamiętać, żeby brać je z Fresha, nie z instytutem.pl ani nie zgadywać (ustalone wprost przez użytkownika: Fresha jest zawsze aktualna).
- [ ] **Ten sam szablon strony zabiegu do powielenia na ~23 pozostałe zabiegi z menu** — `zabiegi/depilacja-laserowa-plock-lightsheer/index.html` to teraz wzorzec strukturalny (hero z przyciskami/pasek cena+raty/sticky-tabs/akordeon/benefity/cennik/promo/opinie/newsletter/stopka + scroll-reveal).
